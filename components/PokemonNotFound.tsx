...
export default function PokemonNotFound({ searchQuery }: { searchQuery: string }) {
  ...
  return (
    <div className="max-w-2xl mx-auto text-center py-16">
      ...
      <h2 className="text-2xl font-bold text-gray-500 mb-2">Pokémon Not Found</h2>
      ...
      <div className="m-1 justify-center flex">
           <button
                onClick={() => router.push('/')}
                className="flex items-center gap-2 m-4 px-4 py-2 text-black hover:text-gray-900 bg-white hover:bg-gray-100 rounded-lg transition-colors cursor-pointer"
            >
